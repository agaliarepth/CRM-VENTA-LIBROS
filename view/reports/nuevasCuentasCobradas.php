...
header("Content-Disposition: filename=nUEVASCuentasCobradas.xls");
...
<h1 style=" text-align:center; font-size:14px; text-decoration:underline;  margin:0; "> NUEVAS CUENTAS COBRADAS <br/>

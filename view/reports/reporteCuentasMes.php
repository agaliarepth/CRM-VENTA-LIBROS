...
header("Content-Disposition: filename=CuentasRegistradas.xls");
...
?>
    ...
    <h1 style=" text-align:center; font-size:14px; text-decoration:underline;  margin:0; "> CUENTAS REGISTRADAS <br/>
       </h1>

...
header("Content-Disposition: filename=DevolucionCuentas.xls");
...
<h1 style=" text-align:center; font-size:14px; text-decoration:underline;  margin:0; ">  RELACION  DE <?php echo $_POST["tipo"];?><br/>

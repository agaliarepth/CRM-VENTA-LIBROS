...
header("Content-Disposition: filename=CuentasCanceladas.xls");
...
<h1 style=" text-align:center; font-size:14px; text-decoration:underline;  margin:0; "> CUENTAS CANCELADAS <br/>

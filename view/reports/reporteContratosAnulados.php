...
header("Content-Disposition: filename=ContratosAnulados.xls");
...
?>
    ...
    <h1 style=" text-align:center; font-size:14px; text-decoration:underline;  margin:0; ">CONTRATOS ANULADOS<br/>

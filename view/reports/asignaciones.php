...
header("Content-Disposition: filename=Asignaciones.xls");
...
<h1 style=" text-align:center; font-size:14px; text-decoration:underline;  margin:0; "> Asignaciones: <?php echo $_POST['cobrador']?><br/>

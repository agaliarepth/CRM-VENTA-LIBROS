...
<tr>
	...
	<td>
        ...
        <tr>
            ...
            <option value="<?php echo $r["idVendedores"];?>"  <?php if($res["supervisor"]==$r["idVendedores"]){ ?> selected="selected" <?php }?>><?php echo $r["apellidos"]." ".$r["nombres"];?></option>
            <?php }?>
    ...
    <option value="RETIRADO"  <?php if($res["estatus"]=='RETIRADO'){ ?> selected="selected" <?php }?>>RETIRADO</option>
          ...
          <tr>
			...
			<td>
             <input type="text" class="inp-form" id="credito" name="credito" value="<?php echo $res["credito"];?>"/>
            </td>
			<td></td>
		</tr>
         <tr>
         ...
         <select name="tipocomisioncredito" class="inp-form">
         <option value="P" <?php if($res["tipocomisioncredito"]=='P'){?> selected="selected"<?php }?>>POR PORCENTAJE %</option>
         <option value="M" <?php if($res["tipocomisioncredito"]=='M'){?> selected="selected"<?php }?>>POR MONTO FIJO </option>
         </select>
         
         </tH>
         <TD><label>Valor:</label><input class="inp-form"  type="number"  size="10" value="<?php echo $res["valorcomisioncredito"]?>"name="valorcomisioncredito"/></TD>
         </tr>
         <tr>
         <tH>COMISION CONTADO : </tH>
         <tH><label>Tipo de Comision Contado</label>
         <select class="inp-form" name="tipocomisioncontado">
         <option value="P" <?php if($res["tipocomisioncontado"]=='P'){?> selected="selected"<?php }?>>POR PORCENTAJE %</option>
         <option value="M" <?php if($res["tipocomisioncontado"]=='M'){?> selected="selected"<?php }?>>POR MONTO FIJO </option>
         </select>
         
         </tH>
         <TD><label>Valor:</label><input class="inp-form" type="number"  size="10" value="<?php echo $res["valorcomisioncontado"]?>"name="valorcomisioncontado"/></TD>
	...
	<tr>
		...
		<td valign="top">
            ...
            <input type="hidden" name="idValor" value="<?php echo $res["idVendedores"]; ?>"/>

...
$(document).ready(function() {
     ...
     $("#datos_a_enviar").val( $("<div>").append($("#relacionNotasRemision-table").eq(0).clone()).html());
     $("#FormularioExportacion").submit();
});
	 $('#relacionNotasRemision-table').dataTable( {
		 "fnDrawCallback": function (oSettings) {
            if (oSettings.aiDisplay.length == 0) {
                return;
            }
			var nTrs = $('#relacionNotasRemision-table body ');
...
<div id="page-heading">
    <div class="" style="border: solid 1px #999; margin-bottom:20px;">
       <form name="form"   method="post"  action="<?php echo config::ruta();?>?accion=relacionNotasRemision">
      <table>
...
<option value="2024">2024</option>
   ...
   <td>&nbsp;</td>
                <td>
                <input type="hidden" name="consulta" value="relacionNotasRemision"/>
 ...
 <form action="<?php config::ruta();?>?accion=verReporteRelacionNotasRemision" method="post" target="_blank" id="FormularioExportacion">
...
<div id="table-content">
	  ...
	  <div id="message-green">
                ...
                <table border="0"  cellpadding="0"  id="relacionNotasRemision-table" style="font-size:11px; margin:auto; width:100%;">
                <thead>

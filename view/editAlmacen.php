   ...
   <?php if(isset($_GET["m"])) {
	   ...
	   switch($_GET["m"]){
		   case '1':{?>  <div id="message-green">
				...
				<tr>
					<td class="green-left">El almacen  se Ha Registrado Exitosamente..... <a href="<?php config::ruta()?>?accion=almacenAdmin">Volver a la Lista de Almacenes.</a></td>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Adicionar Almacen</a></div>
		...
		<!-- start id-form -->
        <form method="post"  action="" name="form" id="editAlmacen" >
        ...
        <tr>
			...
			<td><input type="text" class="inp-form" id="administrador" name="administrador" value="<?php echo $res["administrador"]; ?>"/>
        ...
        <tr>
			...
			<td><input type="text" class="inp-form" id="fono" name="fono" value="<?php echo $res["fono"]; ?>"/>
	...
	<tr>
		...
		<td valign="top">
			<input type="button" id="bEnviar" value="bEnviar" class="form-submit" name="bEnviar" onclick="document.form.submit();"/>
                          <input type="hidden" name="idValor" value="<?php echo $res["idalmacenes"]; ?>"/>

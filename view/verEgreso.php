...
$(document).ready(function() {
 ...
 <body>
  <div >
 <form action="<?php config::ruta();?>?accion=reporteNotaEgreso" method="post" target="_blank" id="FormularioExportacion">
...
<table width="650" border="0" align="center" style="font-family:calibri; font-size:10px;">
  ...
  <tr>
    <td colspan="5" align="center"  > <p style="font-size:18px; font-family:calibri; font-weight:bold; text-decoration:underline;">NOTA DE EGRESO</p>
      </td>
    <td align="center" style="border:groove;"><span   style="font-size:18px; font-weight:bold; ">N&ordm; :<?php echo $res["idegreso"]; ?></span></td>
  </tr>
  <tr>
    <td width="122"  class="negrita">ENVIA : </td>
    <td  colspan="2" width="275" class="negrita"> <?php echo $res["envia"]; ?></td>
    <td></td>
    <td width="89"  class="negrita">RECIBE:</td>
    <td class="negrita" colspan="2" align="left"><?php echo $res["recibe"]; ?></td>
  </tr>
  <tr>
    ...
    <td class="negrita" colspan="2"><?php echo $res["destino"]; ?></td>
  </tr>
</table>
</td>
</tr>
...
;  font-size:10px;">ENTREGUE  CONFORME</br>

...
<div id="page-heading">
  <h1>Catalogo > Editoriales > Nuevo</h1>
  <br />
  <hr />
   <br />
   <?php if(isset($_GET["m"])) {
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Adicionar Editoriales</a></div>
		...
		<!-- start id-form -->
        <form method="post"  action="" name="form" id="addEditoriales" enctype="multipart/form-data" >
	...
	<div class="bubble-right"></div>
		...
		<tr>
			...
			<td><input type="text" class="inp-form" id="nombre" name="nombre" value=""/>

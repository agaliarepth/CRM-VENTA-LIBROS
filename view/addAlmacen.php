...
<tr>
	...
	<td>
		...
		<!-- start id-form -->
        <form method="post"  action="" name="form" id="addAlmacen" >
        ...
        <tr>
			...
			<td><input type="text" class="inp-form" id="administrador" name="administrador" value=""/>
        ...
        <tr>
			...
			<td><input type="text" class="inp-form" id="fono" name="fono" value=""/>

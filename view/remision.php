...
<div id="page-heading">
 ...
 <tr>
 <td  width="90%">
  <h1>NOTAS DE REMISION  > Listar  </h1>
  </td>
...
<div id="message-blue">
				...
				<tr>
				  <td class="blue-left" > <a href="<?php config::ruta();?>?accion=relacionNotasRemision">Relacion Notas Remision</a> </td>
				...
				<tr>
                    ...
                    <th class="">Estado</th>
                    <th class="">Nota </br>Requerimiento</th>
                   <th class="">Borrar</th>
                ...
                <td>
                    	<a><img src="<?php echo config::ruta();?>images/iconos/imprimir.jpg" width="35" height="35" onclick="imprimir('<?php echo config::ruta();?>?accion=verRemision&id=<?php echo $v["idremision"];?>');"/></a>
                        <a href="<?php echo config::ruta();?>?accion=verFilasKardex&id=<?php echo $v["idremision"];?>&tipo=remision" target="_blank"><img src="<?php echo config::ruta();?>images/iconos/searchkardex.png" width="35" height="35" /></a>
                        
                        
                        
                        </td>
                
                    <td><?php echo $v["idremision"];?></td>
					<td><?php echo $v["fecha"];?></td>
                   
                    <td><?php echo $v["nombre_vendedor"]?></td>
                    <td><?php echo $v["almacen"]?></td>
                    <td><?php echo $v["estado"]?></td>
                    <td><?php echo "RE-".$v["nota_pedido_idnota_pedido"]?></td>
                    	<td>
					
					   <?php if(isset($_SESSION["modulo_almacenes"])&& $v["estado"]=='ANULADO'){?> 
					
					  <a><img src="<?php echo config::ruta();?>images/iconos/delete.png" width="30" height="30" onclick="eliminarRegistro('<?php echo config::ruta();?>?accion=notasRemision&ia=<?php echo $v["idalmacenes"];?>&e=br&sw=<?php echo $v["estado"];?>&ir=<?php echo $v["idremision"];?>','Realmente desea eliminar esta nota.?');"/></a>
					
					<?php }?>
                    <?php if($v["estado"]=="registrado"){?>
				<a> <img src="<?php echo config::ruta();?>images/iconos/nulo.gif" width="35" height="35" onclick="eliminarRegistro('<?php echo config::ruta();?>?accion=notasRemision&e=anular&id=<?php echo $v["idremision"];?>','Realmente desea anular esta nota.?');"/></a>

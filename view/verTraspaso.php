...
<table width="650" border="0" align="center" style="font-family:calibri; font-size:10px;">
  ...
  <tr>
    <td colspan="5" align="center"  ><p style="font-size:18px; font-family:calibri; font-weight:bold; text-decoration:underline;">TRASPASO DE MERCADERIA</p>
      </td>
    <td align="center" style="border:groove;"  ><span   style="font-size:18px; font-weight:bold; ">N&ordm; :<?php echo $res["idtraspasos"]; ?></span></td>
  </tr>
  <tr>
    <td width="122"  class="negrita">NOMBRE ENVIA :    </td>
    <td  colspan="2" width="275" class="negrita"> <?php echo $res["envia"]; ?></td>
    <td></td>
    <td width="89"  class="negrita">FECHA:</td>
    <td class="negrita" colspan="2" align="left"><?php echo $res["fecha"]; ?></td>
  </tr>
  <tr>
    <td class="negrita">NOMBRE RECIBE:</td>
    <td colspan="2" align="left"> <?php echo $res["recibe"]; ?></td>
    <td></td>
    <td class="negrita">&nbsp;</td>
...
<thead>
  ...
  <tr align="center">
    ...
    <td style="font-weight:bold; background-color:#EFEFEF;"><span class="negrita"><?php echo $res["cantidad_total"]; ?></span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<p  style="margin:auto 0; text-align:center; font-size:10px;"><?php echo $res["envia"]; ?></p>
...
<td colspan="5"><p style="font-family:calibri; font-size:10px;" ><b>obs:</b><?php echo $res["obs"]; ?></p></td>
 ...
 <?php if(isset($_GET["id"])){?>
     <p><a href="javascript:void(0)" id="imprime"><img src="<?php config::ruta();?>images/iconos/imprimir.jpg" alt="imprimir">Imprimir</a> </p>
      <p><a href="<?php echo config::ruta();?>?accion=traspasoVendedores" id="imprime">Volver</a></p>

...
<table width="632" border="0" align="center" style="font-family:Calibri; font-size:10px;" >
  ...
  <tr>
    ...
    <td colspan="5" align="center" style="text-decoration:underline" ><span style="font-size:18px; font-family:calibri; font-weight:bold; text-decoration:underline;">DEVOLUCION VENTA</span></td>
    <td colspan="4"><span   style="font-size:18px; font-weight:bold;">N&ordm; Cta :<?php echo $res["num_cuenta"]; ?></span></td>
    </tr>
  <tr>
    <td  class="negrita" colspan="2">NOMBRE CLIENTE:    </td>
    <td colspan="5"> <?php echo $res["cliente"]; ?></td>
    <td class="negrita">NotaIngreso:</td>
    <td colspan="2" class="negrita"><?php echo $res["idingreso"]; ?></td>
  </tr>
  <tr>
    ...
    <td colspan="2" class="negrita"><?php echo $res["fecha"]; ?></td>
  </tr>
  <tr>
    <td class="negrita" colspan="2">COORDINADOR</td>
    <td colspan="2" align="left" class="negrita"><?php echo $res["coordinador"]; ?></td>
    <td align="left" class="negrita">SUPERVISOR</td>
    
    <td colspan="2" ><?php echo $res["supervisor"]; ?></td>
    <td width="59" ><b>GERENTE</b></td>
  ...
  <td width="70"><?php echo $res["cuota_inicial"]; ?></td>
   ...
   <td width="68"><B>PAGO CUENTA</B></td>
  <td></td>
  <td width="94"><B>VALOR DE VOLUMEN</B></td>
  <td width="12"></td>
  </tr>
...
<tr>
  ...
  <tbody>
  <?php  $cont2=0;$cont =1; $cont3=0; foreach($res2 as $v){ ?>
  <tr align="center">
    <td><?php echo $cont;?></td>
...
<td colspan="5"><p style="font-family:calibri; font-size:10px;" ><b>obs:</b><?php echo $res["obs"]; ?></p></td>
 ...
 <p><a href="" id="imprime" onClick="window.close();">Cerrar</a></p>

...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Editar Libros</a></div>
...
if (count($res) == 0 || count($res2) == 0) {
   ...
   <?php 
        ...
        <?php foreach($res2 as $row){?>
			  <option value="<?php echo $row["ideditoriales"]."/".$row["nombre"];?>"<?php if($res["ideditoriales"]==$row["ideditoriales"]) {?> selected="selected"<?php }?> > <?php echo $row["nombre"];?></option><?php }?>
	...
	<div class="bubble-right"></div>
        ...
        <tr>
			...
			<td><input type="text" class="inp-form" id="titulo" name="titulo" value="<?php echo $res["titulo"]; ?>"/>
        ...
        <tr>
			...
			<td><input type="text" class="inp-form" id="tomo" name="tomo" value="<?php echo $res["tomo"]; ?>"/>
        ...
        <tr>
			...
			<td><input type="text" class="inp-form" id="precio_base" name="precio_base" value="<?php echo $res["precio_base"]; ?>"/>
        ...
        <tr>
			...
			<td><input type="text" class="inp-form" id="precio_final" name="precio_final" value="<?php echo $res["precio_final"]; ?>"/>
		...
		<td><textarea rows="" cols="" class="form-textarea" name="observaciones"><?php echo $res["observacion"]; ?></textarea></td>
		<td></td>
	</tr>
	<tr>
		<th>&nbsp;</th>
		<td valign="top">
			<input type="button" id="bEnviar" value="bEnviar" class="form-submit" name="bEnviar" onclick="document.form.submit();"/>
              <input type="hidden" name="idValor" value="<?php echo $res["idlibros"]; ?>"/>

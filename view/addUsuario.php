   ...
   <?php if(isset($_GET["m"])) {
	   ...
	   switch($_GET["m"]){
		   case '1':{?>  <div id="message-green">
				...
				<tr>
					<td class="green-left">El Usuario se Ha Registrado Exitosamente..... <a href="<?php config::ruta()?>?accion=usuarios">Volver a la Lista de Usuarios.</a></td>

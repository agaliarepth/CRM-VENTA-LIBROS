...
<form method="post" action="">
 ...
 <tr>
 <td  WIDTH="">
  <h1>Contratos de Baja 	> Listar  </h1>
  </td>
  <th>
                        ...
                        <tr>
                            ...
                            <td class="options-width">
                                ...
                                <a href="<?php echo config::ruta(); ?>?accion=anularDiferido&id=<?php echo $v["idcontratos"]; ?>"><img
                                        src="<?php echo config::ruta(); ?>images/iconos/anular.jpg" width="20"
                                        height="20" alt="Anular Contrato" title="Anular Contrato"/></a>
                                <a href="###" title="BAJA"> <img
                                        src="<?php echo config::ruta(); ?>images/iconos/rechazar.png" width="20"
                                        height="20"

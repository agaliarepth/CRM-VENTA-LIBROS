...
<div id="page-heading">
  <h1>Catalogo > Editoriales > Editar</h1>
  <br />
  <hr />
   <br />
   <?php if(isset($_GET["m"])) {
	   ...
	   switch($_GET["m"]){
		   case '1':{?>  <div id="message-green">
				...
				<tr>
					<td class="green-left">El Editorial<?php echo $_POST["nombre"];?> se Ha Registrado Exitosamente..... <a href="<?php config::ruta()?>?accion=editoriales">Volver a la Lista de Editoriales.</a></td>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Editar Editoriales</a></div>
		...
		<!-- start id-form -->
        <form method="post"  action="" name="form" id="editEditoriales" enctype="multipart/form-data" >
	...
	<div class="bubble-right"></div>
		...
		<tr>
			...
			<td><input type="text" class="inp-form" id="nombre" name="nombre" value="<?php echo $res["nombre"];?>"/>
	...
	<tr>
		...
		<td valign="top">
            ...
            <input type="hidden" name="id" value="enviar"/>
                          <input type="hidden" name="idValor" value="<?php echo $res["ideditoriales"]; ?>"/>

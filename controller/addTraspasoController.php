...
if(isset($_POST["ienviar"])&&isset($_POST["nombre_vendedor"])){

$cad=explode("||",$_POST["nombre_vendedor"]);

$res=$kv->todasRemisiones($cad[0]);
$res3=$ve->listartodos();
 require_once("view/addTraspaso.php");
}
...
if(isset($_POST["enviarTraspaso"])&&$_POST["enviarTraspaso"]=="enviarTraspaso"){
